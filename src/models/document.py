...
# C3 decision: εδάφιο → <subparagraph>, περίπτωση → <list>/<point>
# subparagraph = εδάφιο (continuous prose subdivision of a paragraph)
# list/point   = περίπτωση (enumerated item, alphabetic or numeric)
# This mapping is used consistently throughout the renderer and UI.
...
class Document:
    ...
    amendments:      list = field(default_factory=list)   # D2: textualMod records
    ...
    def from_dict(data: dict) -> "Document":
        ...
        d.amendments      = data.get("amendments")  or []
        return d
